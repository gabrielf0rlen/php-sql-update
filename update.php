...
<html>
    ...
    <body style="background-color:#686868;">
        ...
        <section>
        <center><br /><br />
        <form name = "Agendamento" method = "POST" action = "update2.php">
		<fieldset id = "a">
			<legend><b> Informe o ID do Agendamento: </b></legend>
			<p> ID: <input name = "txtid" type = "text" size = "40" maxlength = "40" placeholder="Id do Agendamento">
		</fieldset>
		<br>
		<fieldset id = "b">
			<legend><b> Opcoes: </b></legend>
				<br>
